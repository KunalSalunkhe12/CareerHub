        ...
        <Carousel className="w-full">
          <div className=" flex flex-col md:flex-row-reverse items-center justify-between gap-12">
            ...
            <div className="md:w-1/2 mr-10">
              ...
              <p className="text-gray-500 text-base mb-8">where one can build their own career and growth</p>
          ...
          <div className=" flex flex-col md:flex-row-reverse items-center justify-between gap-12">
            ...
            <div className="md:w-1/2 mr-10">
              ...
              <p className="text-gray-500 text-base mb-8">Ace Your Career and give a it a kick start</p>
              <button className="px-7 py-2 bg-custom_green text-white rounded  hover:bg-slate-500 cursor-pointer transition-all duration-300 hover:-translate-y-4 ">
                Register
              </button>
            </div>
          ...
          <div className=" flex flex-col md:flex-row-reverse items-center justify-between gap-12">
            ...
            <div className="md:w-1/2 mr-10">
              ...
              <p className="text-gray-500 text-base mb-8">where you can able to save jobs </p>
              <button className="px-7 py-2 bg-custom_green text-white rounded  hover:bg-slate-500 cursor-pointer transition-all duration-300 hover:-translate-y-4 ">
                Register
              </button>
            </div>
